...
export class Favorites {
  constructor(root) {
    ...
    GithubUser.search('llink7').then(user => console.log(user))
  }
  ...
  delete(user) {
    const filteredEntries = this
      .entries.filter((entry) => entry.login !== user.login)
  ...
  update() {
    ...
    this.entries.forEach(user => {
      ...
      row.querySelector('.remove').onclick = () => {
        const isOK = confirm('Tem certeza que deseja deletar esse perfil?')
  ...
  createRow() {
    ...
    tr.innerHTML = `
          ...
          <td class="users">
            ...
            <a href="htpps://github.com/maykbrito" target="_blank">
            <p>Mayk Brito</p>
            <span>maykbrito</span>
            </a>
